...
interface RetrofitService {
    ...
    fun addNote(@Field("title") title: String, @Field("content") content: String,
                @Field("date") date: String, @Field("user_id") user_id: String): Call<Unit>

    @FormUrlEncoded
    @POST("/note/modify/note")
    fun modifyNote(@Field("title") title: String, @Field("content") content: String,
                   @Field("date") date: String, @Field("note_id") note_id: String, @Field("user_id") user_id: String): Call<Unit>
